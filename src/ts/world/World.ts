...
export class World
{
	...
	constructor(worldScenePath?: any)
	{
		...
		if (worldScenePath !== undefined)
		{
			...
			loadingManager.onFinishedCallback = () =>
			{
				...
				Swal.fire({
					title: 'XREngine SP Next Gen Physics Sandbox',
					text: 'Explore and interact with available vehicles. Try various scenarios ready to launch from the right panel.',
					footer: '<a href="https://github.com/TheOverlay/physics-sandbox" target="_blank">GitHub</a><a href="https://discord.gg/xrf" target="_blank">Discord</a>',
	...
	{
		// Fonts
		$('head').append('<link href="https://fonts.googleapis.com/css2?family=Roboto" rel="stylesheet">');
		$('head').append('<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">');
		$('head').append('<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet">');

		// Loader
		$(`	<div id="loading-screen">
				<div id="loading-screen-background"></div>
				<h1 id="main-title" class="sb-font">XRE Next Gen Physics Sandbox</h1>
				<div class="cubeWrap">
					<div class="cube">
				...
				<div id="loading-text">Loading SP...</div>
			</div>
		`).appendTo('body');
